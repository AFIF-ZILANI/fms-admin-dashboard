...
type SpendByCategoryChartProps = { days: number };

export function SpendByCategoryChart({ days }: SpendByCategoryChartProps) {
  const { data, isLoading, isError } = useGetData<PurchasesByCategoryRow[]>(
